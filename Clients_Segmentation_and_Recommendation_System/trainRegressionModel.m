...
% Auto-generated by MATLAB on 30-May-2021 20:18:11
...
predictorNames = {'Wealth*Age', 'Age', 'Financial Education', 'Income', 'Wealth', 'ratio'};
predictors = inputTable(:, predictorNames);
response = inputTable.RiskPropensity;
isCategoricalPredictor = [false, false, false, false, false, false];

% Train a regression model
% This code specifies all the model options and trains the model.
concatenatedPredictorsAndResponse = predictors;
concatenatedPredictorsAndResponse.RiskPropensity = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'Age', 'Financial Education', 'Income', 'Wealth', 'Wealth*Age', 'ratio'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.RiskPropensity = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'interactions', ...
        'RobustOpts', 'off');
